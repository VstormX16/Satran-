...
face_1 = get_face_descriptor("C:/Users/kaand/Desktop/Projler/deneme/kaan.jpg")  # İlk kişi fotoğrafı
face_2 = get_face_descriptor("C:/Users/kaand/Desktop/Projler/deneme/kevser.jpg")  # İkinci kişi fotoğrafı
face_3 = get_face_descriptor("C:/Users/kaand/Desktop/Projler/deneme/zeynep.jpg")  # Üçüncü kişi fotoğrafı
face_4 = get_face_descriptor("C:/Users/kaand/Desktop/Projler/deneme/etem.jpg")  # Dördüncü kişi fotoğrafı

# Özellik vektörlerini kaydedin
np.save("face_1.npy", face_1)
np.save("face_2.npy", face_2)
np.save("face_3.npy", face_3)
np.save("face_4.npy", face_4)  # Yeni yüzü kaydediyoruz
